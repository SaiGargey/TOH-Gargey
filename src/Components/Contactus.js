...
export default function contact(){
    return(
        ...
        <div>
        <h3>Contact Us On:</h3>
        <Link to="https://www.instagram.com/gargey.7/#" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" style={{width:"60px", height:"60px", fill:"black"}} class="bi bi-instagram" viewBox="0 0 16 16">
        ...
        <Link to="https://forms.gle/PYyGzo6b5omSLrDM7" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" style={{width:"70px", height:"70px", fill:"black",marginLeft:"30px"}} class="bi bi-envelope" viewBox="0 0 16 16">
